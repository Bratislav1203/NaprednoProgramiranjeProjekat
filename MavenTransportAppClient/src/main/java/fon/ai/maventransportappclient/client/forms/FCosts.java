...
public class FCosts extends javax.swing.JFrame {
    ...
    public FCosts(Drive drive, FDrive fd) {
        ...
        if(drive != null){
            for(CostItem c : drive.getCostList().getCosts()){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            costs.add(new CostItem(CostType.driverSallary, driverSallary));
            double fuel = Double.parseDouble(jTextFuel.getText());
            costs.add(new CostItem(CostType.fuel, fuel));
            double toll = Double.parseDouble(jTextToll.getText());
            costs.add(new CostItem(CostType.toll, toll));
        ...
        try {
            ...
            for(CostItem c : costs) {
            	cl.dodajTrosakUTotal(c);
            }
            CommunicationController.getInstance().setCostList(cl);
            this.dispose();
            fd.omoguciSave();
            fd.setEnabled(true);
    ...
    private void jButtonPrikazActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrikazActionPerformed
        ...
        try{
            ...
            costs.add(new CostItem(CostType.toll, toll));
            double other = Double.parseDouble(jTextOther.getText());
            costs.add(new CostItem(CostType.other, toll));
            cl.setCosts(costs);
            for(CostItem citem : costs) {
            	citem.setCostList(cl);
            }
